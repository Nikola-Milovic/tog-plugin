...
//func C(x, y, r float32) Circ {
//	return Circ{Vector{x, y}, r}
//}
//
...
//}
//
//func (c Circ) Intersect(s Circ) (k, p Vector) {
//	/*
//		a*a = ca*ca + h*h
//		b*b = cb*cb + h*h
//		c = ca + cb
...
//func (c Circ) ProjectX(x float32) (a, b float32) {
//	/*
...
//func (c Circ) ProjectY(y float32) (a, b float32) {
//	/*
//		(X - c.C.X)^2 + (Y - c.C.Y)^2 = c.R^2
...
//func (c Circ) SimplePrjX(x float32) float32 {
//	/*
...
//func (c Circ) SimplePrjY(y float32) float32 {
//	y -= c.C.Y
...
//func (c Circ) Contains(pos Vector) bool {
